 ...
 *
 *************************************************************************/
#ifndef MODULES_SOURCE_SRC_UTIL_VIDEO_DECODER_HPP_
#define MODULES_SOURCE_SRC_UTIL_VIDEO_DECODER_HPP_
#include <atomic>
#include <memory>
#include <string>
#include <vector>
...
namespace easysa {
    ...
    /*
    * for the future to adapt more decoder, this data struct can add new attribute
    */
    struct ExtraDecoderInfo {
        ...
        bool apply_stride_align_for_scaler = false; 
...
#endif // !MODULES_SOURCE_SRC_UTIL_VIDEO_DECODER_HPP_