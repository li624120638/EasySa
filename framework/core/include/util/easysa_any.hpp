...
using __is_inplace_type = __is_inplace_type_imp<__uncvref_t<_Tp>>;
    ...
    namespace __any_imp {
        ...
        constexpr const void* __get_fallback_typeid() {
            return &__unique_typeinfo< std::decay<_Tp>::type>::__id;
        }
    ...
    public:
        ...
        // assignments
        easysa::any& operator=(easysa::any const& __rhs) {
            easysa::any(__rhs).swap(*this);
            return *this;
        }

        easysa::any& operator=(easysa::any&& __rhs) {
            easysa::any(std::move(__rhs)).swap(*this);
            return *this;
        }
