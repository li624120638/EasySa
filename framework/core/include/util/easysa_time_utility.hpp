 ...
 *************************************************************************/
#ifndef FRAMEWORK_CORE_INCLUDE_UTIL_EASYSA_TIME_UTILITY_HPP_
#define FRAMEWORK_CORE_INCLUDE_UTIL_EASYSA_TIME_UTILITY_HPP_
/*
* @brief this file come from cnstream_time_utility
*/
/// Timestamp utilities
/****************************************************************************
...
namespace easysa {
    ...
    public:
         ...
         */
        explicit Timer(microseconds update_frequency = microseconds(100)) : update_frequency_(update_frequency) {
    ...
    private:
        ...
        void ThreadFunc() {
            ...
            while (!action_queue_.empty() || !main_loop_exit_) {
                action_cond_.wait(lock, [this] { return !action_queue_.empty() || main_loop_exit_; });
...
#endif // FRAMEWORK_CORE_INCLUDE_UTIL_EASYSA_TIME_UTILITY_HPP_