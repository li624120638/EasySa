...
#ifndef FRAMEWORK_CORE_INCLDEU_PROFILER_PROCESS_PROFILER_HPP_
#define FRAMEWORK_CORE_INCLDEU_PROFILER_PROCESS_PROFILER_HPP_
#include <algorithm>
#include <string>
...
#endif // !FRAMEWORK_CORE_INCLDEU_PROFILER_PROCESS_PROFILER_HPP_