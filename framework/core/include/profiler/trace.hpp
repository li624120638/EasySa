 ...
 *************************************************************************/
#ifndef FRAMEWORK_CORE_INCLUDE_PROFILER_TRACE_HPP_
#define FRAMEWORK_CORE_INCLUDE_PROFILER_TRACE_HPP_
#include <chrono>
#include <string>
...
namespace easysa {
     ...
     * Usually, first: stream_name(FrameInfo::stream_id), second: pts(FrameInfo::timestamp).
     **/
    using RecordKey = std::pair<std::string, int64_t>;

    /**
     * struct TraceEvent represents an trace event.
     **/
    struct TraceEvent {
...
#endif // !FRAMEWORK_CORE_INCLUDE_PROFILER_TRACE_HPP_
