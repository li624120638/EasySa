 ...
 *************************************************************************/
#ifndef FRAMEWORK_CORE_INCLUDE_PROFILER_MODULE_PROFILER_HPP_
#define FRAMEWORK_CORE_INCLUDE_PROFILER_MODULE_PROFILER_HPP_
...
namespace easysa {
    ...
    public:
         ...
         * @param key Unique identifier of a FrameInfo instance.
         *
         ...
         *
         * @param stream_name Stream name. Usually it is comes from `FrameInfo::stream_id`.
         *
         * @return void.
         **/
...
#endif // !FRAMEWORK_CORE_INCLUDE_PROFILER_MODULE_PROFILER_HPP_
