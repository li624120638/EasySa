#ifndef FRAMEWORK_CORE_SRC_PROFILER_CIRCULAR_BUFFER_HPP_
#define FRAMEWORK_CORE_SRC_PROFILER_CIRCULAR_BUFFER_HPP_
...
#endif  // FRAMEWORK_CORE_SRC_PROFILER_CIRCULAR_BUFFER_HPP_